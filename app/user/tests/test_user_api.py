...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_invalid_credentials(self):
        """Test taht token is not created if credentials are invalid"""
        create_user(
            username='testuser',
            email='test@test.com',
            password='Testpassword123'
    ...
    def test_create_login_token_no_user(self):
        """Test that token is not created id user does not exist"""
        payload = {
            'username': 'testuser',
            'password': 'Testpassword123'
        }
